...
public class IntegerParameterValue implements IParameterValue {
    ...
    IntegerParameterValue(boolean isOptional, boolean usedDefaultValue, Integer value) {
    ...
    IntegerParameterValue(ParameterValueException ex) {
    ...
    @Override
    public Optional<Integer> getIntegerOptionalValue() {
