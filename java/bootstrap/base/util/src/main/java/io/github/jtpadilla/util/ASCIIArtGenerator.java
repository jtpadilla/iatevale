...
public class ASCIIArtGenerator {
    ...
    static public void print(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol) {
        new ASCIIArtGenerator().printTextArt(artText, textHeight, fontType, artSymbol).forEach(System.out::println);
    }

    static public void print(String artText, int textHeight) {
        new ASCIIArtGenerator().printTextArt(artText, textHeight).forEach(System.out::println);
    }
     ...
     * @throws Exception
     */
    private java.util.List<String> printTextArt(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol) {
     ...
     * @throws Exception
     */
    private java.util.List<String> printTextArt(String artText, int textHeight) {
